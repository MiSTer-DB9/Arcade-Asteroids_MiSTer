		...
		begin
			case (profile_i)
				...
				PROFILE_OVERDRIVEN: fixed_deluxe_1080p = pack_settings(
					...
					HALO_150X, CURVE_STRONG, SPREAD_WIDE2, KNEE_16, INTER_MEDIUM, INTRA_OFF,
					COLOR_DELUXE_BLUE);
		...
		begin
			...
			case (profile_i)
				...
				PROFILE_TYPICAL: fixed_asteroids_lander_480p = pack_settings(
					ARTWORK_ON, ARTWORK_BLEND_0,
					DOT_2X, lander_i ? TONE_LINEAR1 : TONE_LINEAR2, BLOOM_TIGHT, CURVE_MILD,
					HALO_050X, CURVE_MILD, SPREAD_ORIGINAL, KNEE_8, INTER_SHORT, INTRA_OFF,
					normal_color);
				PROFILE_OVERDRIVEN: fixed_asteroids_lander_480p = pack_settings(
					ARTWORK_ON, ARTWORK_BLEND_0,
					DOT_25X, lander_i ? TONE_LINEAR1 : TONE_BRIGHT, BLOOM_TIGHT, CURVE_MILD_P,
					HALO_075X, CURVE_MILD, SPREAD_WIDE1, KNEE_24,
				...
				PROFILE_ULTRAVIOLET: fixed_asteroids_lander_480p = pack_settings(
					ARTWORK_ON, ARTWORK_BLEND_0,
					DOT_3X, TONE_BRIGHT, BLOOM_SOFT, CURVE_STRONG,
					HALO_150X, CURVE_STRONG, SPREAD_WIDE2, KNEE_OFF, INTER_LONG, INTRA_LUT_C,
					COLOR_PURPLE);

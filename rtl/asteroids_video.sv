...
(
	...
	always_ff @(posedge clk_50) begin
		...
		if (authentic_timing_meta == authentic_timing_sync) begin
			if (authentic_timing_sync != stable_authentic_timing) begin
				if (timing_timer < 25'd25_000_000)
	...
	always_ff @(posedge clk_125) begin
		...
		rate_sync <= rate_meta;
		timing_meta <= selected_authentic_timing;
		timing_sync <= timing_meta;
		mode_config_ready <= (height_meta != 12'd0) &&
		                     (rate_meta == rate_sync) &&
		                     (timing_meta == timing_sync);
		...
		if (height_meta != 12'd0) begin
			...
			if ((height_meta >= 12'd1080) && (height_meta < 12'd1400)) begin
				...
				h_total  <= timing_sync ? 12'd1846 : 12'd1903;
				v_total  <= timing_sync ? 12'd1130 : 12'd1124;
				hs_start <= 12'd1600;
				hs_end   <= 12'd1688;
				vs_start <= 12'd1088;
				vs_end   <= 12'd1093;
				...
				h_total  <= timing_sync ? 12'd959 : 12'd1021;
				v_total  <= timing_sync ? 12'd271 : 12'd261;
				hs_start <= 12'd720;
				hs_end   <= 12'd816;
				vs_start <= 12'd245;
				vs_end   <= 12'd248;
				...
				h_total  <= timing_sync ? 12'd959 : 12'd1019;
				v_total  <= timing_sync ? 12'd543 : 12'd524;
				hs_start <= 12'd720;
				hs_end   <= 12'd816;
				vs_start <= 12'd490;
				vs_end   <= 12'd492;
				...
				optimized_ary <= (height_meta >= 12'd1440) ?
				                 (13'h1000 | 13'd1440) :
				                 (13'h1000 | 13'd720);
				h_total  <= (rate_sync || !timing_sync) ?
				            12'd1427 : 12'd1359;
				v_total  <= (rate_sync || !timing_sync) ?
				            12'd749 : 12'd767;
				hs_start <= 12'd1108;
				hs_end   <= 12'd1196;
				vs_start <= 12'd728;
	...
	asteroids_geometry geometry (
		...
		.zoom_wide(geometry_zoom_wide_q),
		.raster_x(raster_x),
		.raster_y(raster_y),

//============================================================================
//  Atari POKEY output filter
//
//  Written 2026 by Videodr0me
//
//  Models the 10 kOhm / 15 nF low-pass network used on the Asteroids Deluxe
//  POKEY output.
//============================================================================

module atari_pokey_filter
(
	input  logic       clk,
	input  logic       reset,
	input  logic       ce,
	...
	always_comb begin
		...
		// 9/2048 at 1.512 MHz gives the nominal 150 us time constant.
	...
	always_comb begin
		audio_out = enable ? filtered_q[FRACTION_BITS +: 8] : audio_in;
	end
